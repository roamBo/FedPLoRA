...
- 详见 [branches/BRANCH_A_HierPlus.md](branches/BRANCH_A_HierPlus.md)，实现见 [methods/fedplora_v4_hier.py](methods/fedplora_v4_hier.py)。
...
- 详见 [branches/BRANCH_B_SVD.md](branches/BRANCH_B_SVD.md)。
...
- 详见 [branches/BRANCH_C_Sign.md](branches/BRANCH_C_Sign.md)，实现见 [methods/fedplora_v4_sign.py](methods/fedplora_v4_sign.py)（实际只是本地正则项，聚合复用 v2）。
...
- 详见 [branches/BRANCH_D_Mix.md](branches/BRANCH_D_Mix.md)，实现见 [methods/fedplora_v4_mix.py](methods/fedplora_v4_mix.py)。
...
- 详见 [branches/BRANCH_E_Anchor.md](branches/BRANCH_E_Anchor.md)。
...
- 详见 [branches/BRANCH_F_AdaRank.md](branches/BRANCH_F_AdaRank.md)。
...
新增脚本：[utilities/eval_robust.py](utilities/eval_robust.py)（待实现），[scripts/Analysis/summarize_v4.py](scripts/Analysis/summarize_v4.py)（已实现）。
