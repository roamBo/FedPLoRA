#!/usr/bin/env bash
# Group 3 — FedAvg-Normal only (full training; checkpoints saved).
# Flora / FFA are in run_domain_sft_batch_group4_flora_ffa.sh.
#
# Usage:
#   bash scripts/RunScripts/run_domain_sft_batch_group3_normal.sh [7|14|21|35] [gpu]
...
domain_sft_run_batch "batch-group3-normal" normal
