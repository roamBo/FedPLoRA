#!/usr/bin/env bash
# Single method: fedsa_lora (FedSA-LoRA). Speed flags via _fed_train_speed.inc.sh / env.
#
# Usage (from repo root):
#   bash scripts/RunScripts/run_domain_sft_fedsa_lora.sh [7|14|21|35] [gpu]
...
AGG_TYPE="fedsa_lora"
echo "[run_domain_sft_fedsa_lora] clients=${NC} benchmark_dir=${BENCHMARK_DIR}"
