#!/usr/bin/env bash
# Single method: fedplora-oneshot (FedPLoRA-Oneshot). Speed flags via _fed_train_speed.inc.sh / env.
#
# Usage (from repo root):
#   bash scripts/RunScripts/run_domain_sft_fedplora_oneshot.sh [7|14|21|35] [gpu]
...
echo "[run_domain_sft_fedplora_oneshot] clients=${NC} benchmark_dir=${BENCHMARK_DIR}"
