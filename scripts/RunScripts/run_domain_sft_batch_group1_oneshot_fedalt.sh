...
#
# Env overrides: configs/domain_sft.env (MODEL_PATH, SEED, DATALOADER_NUM_WORKERS, ATTN_IMPLEMENTATION, …).
...
domain_sft_run_batch "batch-group1-oneshot-fedalt" fedplora-oneshot fedalt
