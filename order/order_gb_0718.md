# FedPLoRA 20260718：顶会投稿实验完整性复核与待运行命令（gb 服务器）

> 由 `order/order_20260718_require.md` 适配。章节编号、命令格式与原文一致；仅替换服务器路径、conda、GPU。
...
```text
run_logs:    /data/yaominghao/gb/result/FedPLoRA/<RUN_ID>/run_logs/
result_logs: /data/yaominghao/gb/result/FedPLoRA/<RUN_ID>/result_logs/
result_files:/data/yaominghao/gb/result/FedPLoRA/<RUN_ID>/result_files/
audit:       /data/yaominghao/gb/result/FedPLoRA/audit_20260718/
```
...
```bash
exec bash
# 交互壳可用 conda；若当前已 set -u，先：export PS1="${PS1-}"
# nohup / 非交互脚本不要 source conda.sh，改用 PATH=.../envs/fedplora/bin
...
nohup bash -s > /data/yaominghao/gb/result/FedPLoRA/audit_20260718/run_logs/compute_environment.log 2>&1 <<'BASH' &
...
```bash
mkdir -p /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_offset_smoke/pipeline_logs

PATH="/data/yaominghao/miniconda3/condabin:${PATH}" \
EXPECTED_NUM_CLIENTS=20 \
BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 \
...
nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh \
  ...
  > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_offset_smoke/pipeline_logs/X2_flower_offset1_smoke_seed42.launch.log 2>&1 &
```

Smoke 完成后检查：

```bash
SMOKE_JSON=/data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_offset_smoke_seed42/result_logs/X2_flower_offset1_smoke_seed42_seed42.json
...
```bash
mkdir -p /data/yaominghao/gb/result/FedPLoRA/qwen3b_20260718_coldstart_smoke/pipeline_logs

PATH="/data/yaominghao/miniconda3/condabin:${PATH}" \
MODEL_PATH=/data/yaominghao/gb/models/Qwen2.5-3B \
...
nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh \
  ...
  > /data/yaominghao/gb/result/FedPLoRA/qwen3b_20260718_coldstart_smoke/pipeline_logs/X2_qwen3b_flower_coldstart_smoke_seed42.launch.log 2>&1 &
```
...
GPU=1 run_sft_smoke smoke_qwen3b_normal normal --force_retrain
...
GPU=1 run_sft_smoke smoke_v13a_qwen3b fedplora_v13a_os --force_retrain
```
...
GPU=1 run_sft_smoke smoke_v13a_route_global fedplora_v13a_os --expert_cluster_mode global --force_retrain
...
运行量：`4 offsets × 3 seeds = 12` 个独立 nohup、独立 PID、独立结果目录。以下命令格式与原文一致（一次粘贴多条）；gb 全部 --gpu 1，同卡不要同时启动两条，资源紧时请注释未跑行或等前一条结束。

### 1.2 offset1 × seeds42/43/44

```bash
mkdir -p /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs

PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset1_seed42 --seed 42 --split-seed 42 --run-id-prefix flowertune_20260718_loco_offset1 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 1 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset1_seed42.launch.log 2>&1 &

PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset1_seed43 --seed 43 --split-seed 43 --run-id-prefix flowertune_20260718_loco_offset1 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 1 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset1_seed43.launch.log 2>&1 &

PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset1_seed44 --seed 44 --split-seed 44 --run-id-prefix flowertune_20260718_loco_offset1 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 1 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset1_seed44.launch.log 2>&1 &
```

### 1.3 offset2 × seeds42/43/44

```bash
PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset2_seed42 --seed 42 --split-seed 42 --run-id-prefix flowertune_20260718_loco_offset2 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 2 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset2_seed42.launch.log 2>&1 &

PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset2_seed43 --seed 43 --split-seed 43 --run-id-prefix flowertune_20260718_loco_offset2 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 2 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset2_seed43.launch.log 2>&1 &

PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset2_seed44 --seed 44 --split-seed 44 --run-id-prefix flowertune_20260718_loco_offset2 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 2 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset2_seed44.launch.log 2>&1 &
```

### 1.4 offset3 × seeds42/43/44

```bash
PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset3_seed42 --seed 42 --split-seed 42 --run-id-prefix flowertune_20260718_loco_offset3 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 3 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset3_seed42.launch.log 2>&1 &

PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset3_seed43 --seed 43 --split-seed 43 --run-id-prefix flowertune_20260718_loco_offset3 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 3 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset3_seed43.launch.log 2>&1 &

PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset3_seed44 --seed 44 --split-seed 44 --run-id-prefix flowertune_20260718_loco_offset3 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 3 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset3_seed44.launch.log 2>&1 &
```

### 1.5 offset4 × seeds42/43/44

```bash
PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset4_seed42 --seed 42 --split-seed 42 --run-id-prefix flowertune_20260718_loco_offset4 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 4 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset4_seed42.launch.log 2>&1 &

PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset4_seed43 --seed 43 --split-seed 43 --run-id-prefix flowertune_20260718_loco_offset4 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 4 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset4_seed43.launch.log 2>&1 &

PATH="/data/yaominghao/miniconda3/condabin:${PATH}" EXPECTED_NUM_CLIENTS=20 BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42 BENCHMARK_REQUIRED_SPLIT_SEEDS="42 43 44" RUN_TAG_DATASET=flowertune20c_dir05 PIPELINE_EVAL_MAX_BATCHES=0 PIPELINE_ROUNDS=1 nohup /usr/bin/time -v bash scripts/RunScripts/run_20260713_one_experiment.sh --kind personalized_eval --method X2_flower_loco_offset4_seed44 --seed 44 --split-seed 44 --run-id-prefix flowertune_20260718_loco_offset4 --gpu 1 -- --held_out_clients auto_one_per_domain --held_out_policy offset --held_out_offset 4 --schemes base,global,coldstart,coldstart_geom,v11c_coldstart,select_without_local --select_candidates base,global,coldstart,coldstart_geom,v11c_coldstart --few_shot_caps 5,10 --held_out_route_probe_samples 10 --eval_on_local --cold_start --v11c_mu 0.4 > /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_loco_launcher/pipeline_logs/X2_flower_loco_offset4_seed44.launch.log 2>&1 &
```
...
CUDA_VISIBLE_DEVICES=1 nohup /usr/bin/time -v python -u scripts/Analysis/diag_subspace_AB.py --model /data/yaominghao/gb/models/SmolLM2-135M --benchmark_dir "$DIAG_BENCH_ROOT/seed_44" --target_modules q_proj,k_proj,v_proj,o_proj,gate_proj,up_proj,down_proj --torch_dtype bfloat16 --batch_size 2 --max_seq_length 256 --lr 0.0002 --local_epochs 1 --max_steps 0 --seed 44 --n_null 200 --out /data/yaominghao/gb/result/FedPLoRA/audit_20260718/analysis/diag_subspace_AB_seed44.json --save_figs > /data/yaominghao/gb/result/FedPLoRA/audit_20260718/run_logs/diag_subspace_AB_seed44.log 2>&1 &
```
...
CUDA_VISIBLE_DEVICES=1 nohup /usr/bin/time -v python -u scripts/Analysis/diag_b_swap.py --model /data/yaominghao/gb/models/SmolLM2-135M --benchmark_dir "$DIAG_BENCH_ROOT/seed_44" --target_modules q_proj,k_proj,v_proj,o_proj,gate_proj,up_proj,down_proj --torch_dtype bfloat16 --batch_size 2 --eval_batch_size 2 --max_seq_length 256 --lr 0.0002 --local_epochs 1 --max_steps 0 --eval_max_batches 20 --n_peers 4 --n_cross 2 --seed 44 --out /data/yaominghao/gb/result/FedPLoRA/audit_20260718/analysis/diag_b_swap_seed44.json > /data/yaominghao/gb/result/FedPLoRA/audit_20260718/run_logs/diag_b_swap_seed44.log 2>&1 &
```
...
GPU=1 run_sft_full N7_ours_v13a_route_global_d1 fedplora_v13a_os --expert_cluster_mode global --force_retrain
...
```bash
export MODEL_PATH=/data/yaominghao/gb/models/SmolLM2-135M
export BENCHMARK_DIR_MAIN=/data/yaominghao/gb/FedPLoRA/data/domain_benchmark_flowertune_mixed_20c_dir05/seed_42
export BENCHMARK_REQUIRED_SPLIT_SEEDS="42"
...
GPU=1 run_sft_full N7_ours_v13a_route_global_flower fedplora_v13a_os --expert_cluster_mode global --force_retrain
GPU=1 run_sft_full N7_ours_v13a_route_oracle_domain_flower fedplora_v13a_os --expert_cluster_mode domain --force_retrain
```
...
```bash
mkdir -p /data/yaominghao/gb/result/FedPLoRA/qwen3b_20260718_flower_coldstart_launcher/pipeline_logs
...
nohup /usr/bin/time -v bash -s > /data/yaominghao/gb/result/FedPLoRA/audit_20260718/run_logs/flower_loco_paired_stats.log 2>&1 <<'BASH' &
# 勿 source conda.sh + set -u（nohup 无 PS1 → unbound variable）
set -eo pipefail
export PATH="/data/yaominghao/miniconda3/envs/fedplora/bin:${PATH}"
python - <<'PY'
...
rg -n -i 'Traceback|CUDA out of memory|ModuleNotFoundError|FileNotFoundError|\[.*error\]|nan' \
  /data/yaominghao/gb/result/FedPLoRA/flowertune_20260718_* \
  /data/yaominghao/gb/result/FedPLoRA/ref_20260718_* \
  /data/yaominghao/gb/result/FedPLoRA/audit_20260718/run_logs \
  /data/yaominghao/gb/result/FedPLoRA/qwen3b_20260718_* 2>/dev/null || true
```
